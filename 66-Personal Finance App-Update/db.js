class DB {
        ...
        this.connection.onupgradeneeded = function (event) {
            ...
            stores.forEach((store) => {
                var objectStore = this.database.createObjectStore(store.name, {
                    ...
                    autoIncrement: store.autoIncrement? true:false, // Add auto-increment property
                });
    ...
    */
    ...
    /**
     * Get all data within a range from the database
     * @param {string} store - The store to get the data from
     * @param {string} index - The index to get the data from
     * @param {string} lower - The lower bound of the range
     * @param {string} upper - The upper bound of the range
     */
